...
class ProfileDoctor extends Component {
    ...
    render() {
        ...
        if(dataProfile && dataProfile.positionData){
            nameVi = `${dataProfile.positionData.valueVi}, ${dataProfile.lastName} ${dataProfile.firsName}`;
            nameEn = `${dataProfile.positionData.valueEn}, ${dataProfile.firsName} ${dataProfile.lastName}`;
        }
        return (
