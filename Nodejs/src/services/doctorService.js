        ...
        try {
            ...
            if (checkObj.isValid === false) {
                ...
                if (inputData.action === 'CREATE') {
                    ...
                    resolve({
                        errCode: 0,
                        errorMessage: 'Save infor doctor successfully'
                    })
        ...
        try {
            if (!data.arrSchedule || !data.doctorId || !data.formatedDate) {
                ...
                let toCreate = _.differenceWith(schedule, existing, (a, b) => {
                    return a.timeType === b.timeType && a.data === b.data;
                })
            ...
            if (!doctorId || !date) {
                ...
                let dataSchedule = await db.Schedule.findAll({
                    ...
                    include: [
                        ...
                        { model: db.User, as: 'doctorData', attributes: ['firsName', 'lastName'] },
                    ],
                    raw: false,
                    nest: true,
                })
            ...
            if (!doctorId || !date) {
                ...
                let data = await db.Booking.findAll({
                    ...
                    include: [{
                            model: db.User,
                            as: 'patientData',
                            attributes: ['email', 'firsName', 'address', 'gender'],
                            include: [{
                                model: db.Allcode,
                                as: 'genderData',
